                       ...
                       _Flt_CompletionContext_Outptr_ PVOID *CompletionContext)
{
    ...
    case IRP_MJ_SET_INFORMATION: {
            ...
            (((PFILE_DISPOSITION_INFORMATION)(Data->Iopb->Parameters.SetFileInformation.InfoBuffer))->DeleteFile))
        {
            ...
            //
            // ** NEW CODE TO BLOCK DELETION **
            // To block this file deletion, uncomment the following lines.
            // This will deny the request and stop the operation.
            //
            /*
            DbgPrint("!!! FSFilter: Blocking file deletion for %wZ\n", FilePath);
            Data->IoStatus.Status = STATUS_ACCESS_DENIED;
            Data->IoStatus.Information = 0;
            delete newEntry; // Clean up the allocated entry
            FltReleaseFileNameInformation(nameInfo); // Clean up name info
            return FLT_PREOP_COMPLETE;
            */
